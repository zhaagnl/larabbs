...
class Kernel extends HttpKernel
{
     ...
     */
    // 中间件别名设置，允许你使用别名调用中间件，例如上面 api 中间件组调用
    protected $routeMiddleware = [
        ...
        // session 用来保证“登录状态”与“当前密码”一致，密码变更后让旧会话失效。
        ...
        // Laravel 自带的强制用户邮箱认证中间件，为了更加贴近我们的逻辑，已被重写
